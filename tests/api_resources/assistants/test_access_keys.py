...
class TestAccessKeys:
    ...
    def test_method_retrieve(self, client: Agility) -> None:
        access_key = client.assistants.access_keys.retrieve(
    ...
    def test_raw_response_retrieve(self, client: Agility) -> None:
        response = client.assistants.access_keys.with_raw_response.retrieve(
            access_key_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            assistant_id="assistant_id",
        )
    ...
    def test_streaming_response_retrieve(self, client: Agility) -> None:
        with client.assistants.access_keys.with_streaming_response.retrieve(
            access_key_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            assistant_id="assistant_id",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_retrieve(self, client: Agility) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `assistant_id` but received ''"):
            client.assistants.access_keys.with_raw_response.retrieve(
                access_key_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
                assistant_id="",
            )
...
class TestAsyncAccessKeys:
    ...
    async def test_method_retrieve(self, async_client: AsyncAgility) -> None:
        access_key = await async_client.assistants.access_keys.retrieve(
            access_key_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            assistant_id="assistant_id",
        )
        assert_matches_type(AccessKey, access_key, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncAgility) -> None:
        response = await async_client.assistants.access_keys.with_raw_response.retrieve(
            access_key_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            assistant_id="assistant_id",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncAgility) -> None:
        async with async_client.assistants.access_keys.with_streaming_response.retrieve(
            access_key_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            assistant_id="assistant_id",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_retrieve(self, async_client: AsyncAgility) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `assistant_id` but received ''"):
            await async_client.assistants.access_keys.with_raw_response.retrieve(
                access_key_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
                assistant_id="",
            )
