...
class TestHealth:
    ...
    @parametrize
    def test_method_check(self, client: Agility) -> None:
        health = client.health.check()
        assert_matches_type(HealthCheckResponse, health, path=["response"])

    @parametrize
    def test_raw_response_check(self, client: Agility) -> None:
    ...
    @parametrize
    def test_streaming_response_check(self, client: Agility) -> None:
...
class TestAsyncHealth:
    ...
    @parametrize
    async def test_method_check(self, async_client: AsyncAgility) -> None:
        health = await async_client.health.check()
        assert_matches_type(HealthCheckResponse, health, path=["response"])

    @parametrize
    async def test_raw_response_check(self, async_client: AsyncAgility) -> None:
    ...
    @parametrize
    async def test_streaming_response_check(self, async_client: AsyncAgility) -> None:
