...
def _get_open_connections(client: Agility | AsyncAgility) -> int:
...
class TestAgility:
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "agility/_legacy_response.py",
                        "agility/_response.py",
    ...
    def test_base_url_trailing_slash(self, client: Agility) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: Agility) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: Agility) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    @mock.patch("agility._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retries_taken(self, client: Agility, failures_before_success: int, respx_mock: MockRouter) -> None:
        ...
        respx_mock.post("/api/assistants/").mock(side_effect=retry_handler)
    ...
    def test_omit_retry_count_header(
        self, client: Agility, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
...
class TestAsyncAgility:
    ...
    def test_base_url_trailing_slash(self, client: AsyncAgility) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncAgility) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncAgility) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_retries_taken(
        self, async_client: AsyncAgility, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
