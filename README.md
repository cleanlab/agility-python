...
The Agility Python library provides convenient access to the Agility REST API from any Python 3.7+
...
You can enable logging by setting the environment variable `AGILITY_LOG` to `debug`.

```shell
$ export AGILITY_LOG=debug
```
